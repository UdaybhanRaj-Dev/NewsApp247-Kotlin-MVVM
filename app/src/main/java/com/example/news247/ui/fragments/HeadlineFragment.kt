...
import com.example.news247.databinding.FragmentHeadlineBinding
...
class HeadlineFragment : Fragment(R.layout.fragment_headline) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        itemHeadlineError=view.findViewById(R.id.itemhedingerror)
        ...
        newsAdapter.setOnItemClickListner {
            ...
            findNavController().navigate(R.id.action_headlineFragment_to_articalFragment,bundle)
        }
    ...
    private  fun setupHeadlinesRecycler()
    {
        ...
        binding.recyclerHeadlines.apply{
            ...
            addOnScrollListener(this@HeadlineFragment.scrollListner)
        }
    }
